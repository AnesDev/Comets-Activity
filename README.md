...
3. Test on a single case before full runs
4. Document new physics modules in `physics/`
5. Submit PR with results and visualizations

## References

- **NeuralPDE.jl**: Physics-informed learning framework
- **Cometary Science**: Sublimation models based on established literature
- **Deep Learning**: Modern optimization and architecture choices
...
For questions about this internship project, contact the repository owner or project supervisor.
